...
<nav class="bg-gray-800 rounded-2xl text-2xl">
    ...
    <div class="relative flex h-24 items-center justify-between">
      ...
      <div class="flex flex-1 items-center justify-center sm:items-stretch sm:justify-start">
        ...
        <div class="flex flex-1 space-x-4">
          <a hx-boost="true" href="/demos/infinite-scroll#scroller" class="flex-1 text-center rounded-xl hover:bg-gray-700 hover:text-white px-3 py-4 text-white">Easiest</a>
          <a hx-boost="true" href="/demos/infinite-scroll/smoother#scroller" class="flex-1 text-center rounded-xl px-3 py-4 text-gray-300 hover:bg-gray-700 hover:text-white">Smoother</a>
          <a hx-boost="true" href="/demos/infinite-scroll/insane#scroller" class="flex-1 text-center rounded-xl px-3 py-4 text-gray-300 bg-gray-900" aria-current="page">Insane</a>
        </div>
      </div>
    </div>
  </div>
  ...
  <table class="mt-6 w-full whitespace-nowrap text-left">
    ...
    <thead class="border-b border-white/10 text-sm/6 text-white">
      ...
      @include('demos.infinite-scroll.insane-rows')
