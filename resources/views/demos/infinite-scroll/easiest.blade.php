...
<nav class="bg-gray-800 rounded-2xl text-2xl">
    ...
    <div class="relative flex h-24 items-center justify-between">
      ...
      <div class="flex flex-1 items-center justify-center sm:items-stretch sm:justify-start">
        ...
        <div class="flex flex-1 space-x-4">
          <a hx-boost="true" href="/demos/infinite-scroll#scroller" class="flex-1 text-center rounded-xl bg-gray-900 px-3 py-4 text-white" aria-current="page">Easiest</a>
  ...
  <table class="mt-6 w-full whitespace-nowrap text-left">
    ...
    <tbody class="divide-y divide-white/5">
      @include('demos.infinite-scroll.easiest-rows')
    </tbody>
  </table>
</div>
</div>
