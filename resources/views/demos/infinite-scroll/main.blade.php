    ...
    <div class="py-24 sm:py-32 lg:pb-40">
      <div class="mx-auto max-w-7xl px-6 lg:px-8">
        <div class="mx-auto max-w-2xl text-center">
          ...
          <p class="mt-8 text-pretty text-lg font-medium text-gray-400 sm:text-xl/8">I don't know what you're scrolling to. I don't care what you want to find. But, listen: neither do you. Just keep scrolling.</p>
        ...
        <!-- <img src="https://tailwindcss.com/plus-assets/img/component-images/dark-project-app-screenshot.png" alt="App screenshot" width="2432" height="1442" class="mt-16 rounded-md bg-white/5 shadow-2xl ring-1 ring-white/10 sm:mt-24"> -->
      </div>
    </div>
