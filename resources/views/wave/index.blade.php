    ...
    <div class="bg-white px-6 py-12 shadow sm:rounded-lg sm:px-12">
      ...
      <div class="relative mt-10">
        ...
        <div class="mt-6 grid grid-cols-2 gap-4">
          <a href="https://youtu.be/UXPD3LblwVA" class="flex w-full items-center justify-center gap-3 rounded-md bg-white px-3 py-2 text-sm font-semibold text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 hover:bg-gray-50 focus-visible:ring-transparent">
